...
export interface ApiQuizProgressQuizProgress
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    quizProgress: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    correct_answer_index: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::quiz.quiz'> &
      Schema.Attribute.Private;
    options: Schema.Attribute.Component<'general.option', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quiz_progresses: Schema.Attribute.Relation<
      'oneToMany',
      'api::quiz-progress.quiz-progress'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    blog_comments: Schema.Attribute.Relation<
      'oneToMany',
      'api::blog-comment.blog-comment'
    >;
    blogs: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'>;
